  ...
  const RULES = [
    {
      ...
      "answer": "للأسف متصفح Safari على iOS لا يدعم Web Bluetooth، لذا لن يتمكن Face Tracking من الاتصال بجهاز micro:bit على iPad أو iPhone. استخدم Chrome أو Edge على حاسوب محمول أو جهاز Android."
    },
    {
      "id": "chrome-edge",
      "keywords": [
      ...
      "answer": "Face Tracking يعمل في **Chrome 89+** و **Edge 89+** على Windows وmacOS وLinux وChromebook وAndroid. Firefox وSafari غير مدعومَين (لا يوجد Web Bluetooth)."
    },
    {
      "id": "installation",
      "keywords": [
      ...
      "answer": "بدون تثبيت — Face Tracking ملف HTML تفتحه في Chrome أو Edge. حمّل ZIP من Etsy، فك الضغط، انقر مزدوجاً على `index.html`، اضغط **اتصال**، اختر لوحتك."
    },
    {
      "id": "microbit-version",
      "keywords": [
      ...
      "answer": "Face Tracking مُصمَّم لـ **BBC micro:bit V2**. V1.5 يعمل لمستشعرات BLE لكنه بدون ميكروفون أو مكبر صوت. V1.0 لا يدعم Bluetooth LE ولا يمكنه الاتصال."
    },
    {
      "id": "offline",
      "keywords": [
      ...
      "answer": "بعد التحميل الأول، يعمل Face Tracking دون اتصال بالكامل (PWA). مثالي لجدران الحماية المدرسية."
    },
    {
    ...
    },
    {
      ...
      "answer": "Face Tracking متوفر بالإنجليزية والفرنسية والعربية (مع تخطيط RTL كامل). غيّر اللغة من منتقي العلم في أعلى اليمين."
    },
    {
      "id": "updates",
      "keywords": [
    ...
    },
    {
      ...
      "answer": "صفر قياسات عن بُعد. Face Tracking ليس له خادم ولا حساب ولا سحاب. كل بيانات المستشعرات تبقى على جهازك."
    },
    {
      "id": "csv-export",
      "keywords": [
    ...
    },
    {
      ...
      "answer": "Face Tracking يقود محركَي landmark متصلَين بالمنفذَين P1 وP2. علامة تبويب المحركات بها منزلقات، علامة تبويب لوحة اللعب ترسل أوامر اتجاهية."
    }
  ];
