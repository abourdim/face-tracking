...
**Title (140 chars max):**
```
Face Tracking Kids — BLE Control Panel for Teachers & Kids · Sensors · Servos · Live Graph · 3D Models · No Install · Chrome / Edge
```

**160-char short description:**
```
Browser-based BLE control panel for the webcam. Sensors, servos, live graphs, 3D models, and a GamePad — all from Chrome. No install, no account.
```
