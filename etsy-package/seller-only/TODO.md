...
> 🧪 **Live demo**: <https://abourdim.github.io/face-tracking/>
...
- [ ] **Record the 60-second listing video** following
      ...
      with videos by ~30%.
- [ ] **Create the FACELAUNCH Etsy promo code** (Shop Manager → Marketing
      → Sales & coupons → new code `FACELAUNCH`, $8 discount off $14.99,
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `FaceTrackingKids-v1.0.0.zip` actually contains?
...
- [ ] **Create the FACELAUNCH promo code** (first 10 buyers: $14.99 → $8
