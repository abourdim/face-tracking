...
|---|-------------|-----------------|--------------|
| 1 | **Hero** — Stealth theme, Face Overlay tab, micro:bit physically next to laptop | Square crop. App on screen, real hardware in frame. | "micro:bit V2 Playground" + "Instant download" |
...
| 4 | Face Mesh tab, Buggy model rotated to show wheels + LED screen | Drag to a 3/4 angle first | "5 interactive 3D models" |
