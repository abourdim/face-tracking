...
All Etsy-release assets for **Face Tracking Kids**: the ZIP builder, the
...
Produces `etsy-package/FaceTrackingKids-v1.0.0.zip` with the app
...
├── FaceTrackingKids-v1.0.0/         📦 Build staging dir
├── FaceTrackingKids-v1.0.0.zip      📦 Final buyer ZIP
│
