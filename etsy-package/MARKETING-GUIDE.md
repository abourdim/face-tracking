# Marketing Asset Guide — Face Tracking
...
| `output/en/screenshots/screenshot-sensors-annotated.png` | Signals panel with "Live from micro:bit" call-out. |
...
| `graph-record.gif` | Signals panel with Simulate running — live waveform | Etsy listing slot (secondary) · YouTube community post |
...
| `classroom-poster.html` | A3 poster for classroom wall. "We Track Faces in the Browser" + 5 steps. |
...
**Where:** Paste into `face-tracking/index.html` or the hosted live-demo
page (`abourdim.github.io/face-tracking`). Nothing else to do.
...
Output: `output/shared/buyers/FaceTracking-AS-12345-v1.2.0.zip`
...
**Where:**
- Own GitHub repo like `github.com/abourdim/face-tracking-companion`
- Listed in the Etsy description: "MakeCode extension published — search face-tracking-companion"
...
| URL | What buyer sees |
|---|---|
| `#tab=graph` | Signals panel, ready to Simulate |
| `#main` | Product demo screen |
| `#tab=senses&lang=fr` | Signals panel in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/face-tracking/#tab=board3d"
