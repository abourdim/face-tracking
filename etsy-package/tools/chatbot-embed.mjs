...
RULES_BY_LANG.ar = [
  ...
  { id: 'landmarks-motors', keywords: ['landmark', 'محرك', 'تحريك'],
    answer: `${PRODUCT} يقود محركَي landmark متصلَين بالمنفذَين P1 وP2. علامة تبويب المحركات بها منزلقات، علامة تبويب لوحة اللعب ترسل أوامر اتجاهية.` },
];
...
RULES_BY_LANG.fr = [
  ...
  { id: 'landmarks-motors', keywords: ['landmark', 'moteur', 'bouger'],
    answer: `${PRODUCT} pilote deux landmarks connectés aux broches P1 et P2. L'onglet Moteurs a des curseurs, l'onglet Manette envoie des commandes directionnelles.` },
];
...
RULES_BY_LANG.en = [
  ...
  },
  {
    ...
    answer: `The Signals panel records live sensor data and exports CSV — one row per sample, ready for Excel / Sheets / Python. You can also load back a saved CSV and replay it.`,
  },
  {
    id: 'landmarks-motors',
    keywords: ['landmark', 'motor', 'move', 'physical'],
    answer: `${PRODUCT} drives two landmarks connected to pins P1 and P2. The Motors tab has sliders for angle control, the Detections tab sends directional commands, and the 3D tab mirrors the board's orientation in real time.`,
  },
];
