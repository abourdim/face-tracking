...
const I18N = {
  en: { tagline: 'See the live demo in 30s.', role: 'face-tracking · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Chaque capteur, en direct dans le navigateur.', role: 'auteur · face-tracking', contactLabel: 'Contact' },
  ar: { tagline: 'كل حساس، مباشرةً في المتصفح.', role: 'مؤلف · face-tracking', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];
