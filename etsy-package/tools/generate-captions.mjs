...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم MediaPipe · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  kid: {
    ...
    subtitles: [
      `Capteurs, landmarks, fonctionnalités. Sans install. Sans compte.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique MediaPipe · modèles Three.js · source makecode.ts inclus`,
...
TEMPLATES_BY_LANG.en = {
  teacher: {
    ...
    socialCaptions: [
      ...
      `One Etsy download. Zero IT tickets. Thirty students graphing real head yaw data.`,
    ],
    pinCaptions: [
  ...
  kid: {
    ...
    subtitles: [
      `Sensors, landmarks, 3D models. No install. No account.`,
      `Works offline after the first open.`,
      `Draw on the LEDs. Hear the buzzer. Tilt the 3D model.`,
      `11 signals of things to try. Your parents won't understand most of them.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `MediaPipe graph · Three.js models · makecode.ts source included`,
