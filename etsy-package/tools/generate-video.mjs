 ...
 * After apply-template.mjs substitutes Face Tracking Kids / See • Follow • Smile, verify
...
const SCENES = [
  { id: 1, dur: 3,  type: 'title',  text: 'Face Tracking Kids',                   subtitle: 'See • Follow • Smile' },
  { id: 2, dur: 7,  type: 'image',  src: 'screenshot-camera.png', effect: 'zoom-in' },
  { id: 3, dur: 10, type: 'image',  src: 'screenshot-signals.png',       effect: 'pan-right' },
  { id: 4, dur: 10, type: 'image',  src: 'screenshot-settings.png',   effect: 'zoom-in' },
  { id: 5, dur: 10, type: 'image',  src: 'screenshot-camera.png',    effect: 'pan-left' },
  { id: 6, dur: 10, type: 'image',  src: 'screenshot-signals.png',  effect: 'zoom-out' },
  { id: 7, dur: 5,  type: 'cta',    text: 'Full kit',                           subtitle: '' },
  { id: 8, dur: 5,  type: 'end',    text: 'Face Tracking Kids',                   subtitle: '' },
];
...
function sceneImage(s, out) {
  ...
  if (!existsSync(src)) {
    // Back-compat fallback to legacy filename (e.g. screenshot-signals.png).
