...
[face-tracking browser app](https://abourdim.github.io/face-tracking/) —
...
2. **Advanced → Extensions → search** `abourdim/face-tracking-companion`
...
That's it. Sensor stream starts, LEDs / landmarks / buzzer all respond.
...
declares it, `main.ts` is the example, `face-tracking.ts` is the block
