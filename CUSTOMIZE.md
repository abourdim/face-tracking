# Customization checklist — Face Tracking Kids
...
- [ ] `etsy-package/tools/generate-video.mjs` — ffmpeg-based generator
   ...
   `Face Tracking Kids` / `See • Follow • Smile` substitutions don't fit your design.
...
- [ ] (Optional) `gh api -X POST "repos/abourdim/face-tracking/pages" -f 'source[branch]=main' -f 'source[path]=/'` — enable GitHub Pages so the live demo URL in the listing actually works
